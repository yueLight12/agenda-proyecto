...
- El asistente de voz (`tools.py`) tiene una brecha conocida sin cerrar: notas sobre un tema/proyecto directamente (`agregar_nota` solo cubre reunión o entregable) — no construir nada nuevo en la UI sin evaluar si el asistente también lo necesita (regla 7, sección 0).
