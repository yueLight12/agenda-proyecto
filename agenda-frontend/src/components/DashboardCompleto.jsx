...
import PanelResumenProyecto from "./PanelResumenProyecto";

// Dashboard completo (6 indicadores + avance por proyecto + reuniones de la
// semana), sin resumir. Es la vista que ya existía antes de la vista
// simplificada de N1 (ver DashboardSimplificado.jsx) — se usa tal cual para
// usuarios N2/N3/N4, y también dentro del expansor "Ver todos los
// proyectos" de la vista simplificada, para no duplicar esta lógica.
export default function DashboardCompleto({ resumen }) {
